...
public class addStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Blood.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        ...
        setSize(new java.awt.Dimension(611, 786));
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        try{
            String q = "INSERT INTO student (id,stdName,stdFatherName,stdBlood,stdPhone,stdCity,class) value(null,'"+sname+"','"+sfatherName+"','"+sblood+"' , '"+sphone+"' , '"+scity+"', '"+sClass+"')";
